...
base='http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/'
howto='http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/XBMC%20HUB%20GUIDES/txts/howto.txt'
...
def downloadnewrepo(): 
    import xbmc
    url='http://xtyrepo.me/xunitytalk/addons/repository.xunitytalk/repository.xunitytalk-1.0.3.zip'
...
def CATEGORIES():
        ...
        if DEBUG_HUB  or versionNumber < 12:
            addDir('Install Si02 For Eden','http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/info/skin.txt',16,base+'xunity_images/si02.png',base+'xunity_images/fanart/expert.jpg','Adding Your Favourite Tweaks')
...
def allandroid(url):
        addDir("Add GSH's PlayerCore.xml",'http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/playercorefactory.xml',37,base+'xunity_images/android.jpg',base+'xunity_images/fanart/expert.jpg','Change your playercorefactory hardware accelerated players to gsh xml')
...
def maintenance(url):
        ...
        addDir('Download All Repos','http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/allrepos.zip',35,base+'xunity_images/maintenance.jpg',base+'xunity_images/fanart/expert.jpg','Install All Popular Repos In One Click All Repos From Xfinity')
        addDir("Download All UK Plugins/Repos",'http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/uk.zip',35,base+'xunity_images/maintenance.jpg',base+'xunity_images/fanart/expert.jpg','Install All Uk Plugins and Repos')
...
def captcha(url):
    print '############################################################        CAPTCHA FIX       ###############################################################'
    url = 'http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/fix/vidxden.py'
    ...
    DownloaderClass(url,lib)
    url = 'http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/fix/putlocker.py'
    path = xbmc.translatePath(os.path.join('special://home/addons/script.module.urlresolver/lib/urlresolver/','plugins'))
...
def subtitle(url):
    print '############################################################        SUBTITLE FIX       ###############################################################'
    url = 'http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/fix/default.py'
    path = xbmc.translatePath(os.path.join('special://home/addons/','plugin.video.1channel'))
    lib=os.path.join(path, 'default.py')
    DownloaderClass(url,lib)
    url = 'http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/fix/playback.py'
    path = xbmc.translatePath(os.path.join('special://home/addons/','plugin.video.1channel'))
    lib=os.path.join(path, 'playback.py')
    DownloaderClass(url,lib)
    dialog = xbmcgui.Dialog()
...
def sportsdevilfix(name):
    ...
    url = 'http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/fix/sportsdevilfix.zip'
    path = xbmc.translatePath(os.path.join('special://home/addons','packages'))
...
def bbcfix(name):
    print '############################################################        BBC FIX       ###############################################################'
    url = 'http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/fix/plugin.video.iplayer-2.0.18a.zip'
    path = xbmc.translatePath(os.path.join('special://home/addons','packages'))
...
def geek_j1nx_image(name,url,iconimage):
        ...
        if dialog.yesno("What Is Your Box", '','',"",'M3','M1'):
            url='http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/linuxflash/jynx_m1.img'
            print '======= Jynx M1 ======='
            install_linux_image('Jynx M1',url,iconimage)
        else:
            if dialog.yesno("Which Image?", '','',"",'GEEKSQUAD','JYNX'):
                url='http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/linuxflash/jynx_m3.img'
                print '======= Jynx M3 ======='
                install_linux_image('Jynx M3',url,iconimage)
            else:
                url='http://xtyrepo.me/xunitytalk/maintenance_do_not_touch/hubmaintenance/linuxflash/Geeksquad8.m3.img'
                print '======= GEEKSQUAD M3 ======='
